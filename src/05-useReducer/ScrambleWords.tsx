...
export const ScrambleWords = () => {
    ...
    const { words, currentWord, errorCounter, maxSkips, maxAllowErrors, scrambledWord, skipCounter, guess, isGameOver, points, totalWords } = state
